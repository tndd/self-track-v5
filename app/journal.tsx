...
import { Activity, ArrowUpRight, CalendarDays, Check, Download, Droplet, LoaderCircle, LockKeyhole, FlaskConical, Palette, Plus, Send, SlidersHorizontal, Trash2, TrendingUp, Tags } from 'lucide-react';
